			...
			<Helmet>
				...
				<div className="container--works">
					<div className="container--mobile-menu--pages container--mobile-menu--pages--works">
						<Menu 
							currentPage="WORKS" 
							otherPage1={<Link to="/skills">SKILLS</Link>} 
							otherPage2={<Link to="/contact">CONTACT</Link>}
						/>
					</div>
						...
						<div className="container--workitem-rows">
							...
							<Link to="/works/november">
								<WorkItem 
									...
									titleWorkItem="November" 
									descriptionWorkItem={["Designer brand webshop", <br />, "WordPress"]} 
								/>
							</Link>

							<Link to="/works/swarm">
								<WorkItem 
									workItemImage="./images/swarm.png" 
									titleWorkItem="Swarm" 
							...
							<Link to="/works/farest">
								<WorkItem 
									workItemImage="./images/farest.png" 
									titleWorkItem="Farest" 
									descriptionWorkItem={["Adventure travel agency", <br />, "React.js"]}
								/>
							</Link>

							<Link to="/works/borneo">
								<WorkItem 
									workItemImage="./images/borneo.png" 
									titleWorkItem="Borneo" 
									descriptionWorkItem={["Folk art accesories webshop", <br />, "Squarespace"]}
								/>
							</Link>

							<Link to="/works/muskinn">
								<WorkItem 
									workItemImage="./images/muskinn.png" 
									titleWorkItem="Müskinn" 
									descriptionWorkItem={["Conceptual backpack webshop", <br />, "WooCommerce"]}
								/>
							</Link>
